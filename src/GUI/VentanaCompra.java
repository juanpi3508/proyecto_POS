...
public class VentanaCompra extends JFrame {
    ...
    private DefaultTableModel crearModeloTablaProductos(boolean permitirEdicionCantidad) {
        ...
        return new DefaultTableModel(cols, 0) {
            ...
            public boolean isCellEditable(int row, int column) {
                ...
                // SOLO permitir editar la columna CANTIDAD (col = 3)
                if (permitirEdicionCantidad && column == 3) {
                    return true;
                }
