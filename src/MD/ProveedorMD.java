...
public class ProveedorMD {
    ...
    public boolean insertar(Proveedor prv) {
      ...
      try {
          ...
          ps.setString(5, prv.getIdCiudad());  // id_ciudad (CHAR(3))
    ...
    public boolean eliminar(Proveedor prv) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, CargadorProperties.obtenerMessages("PV_E_005"), "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    }
    ...
    public Proveedor verificarMD(String cedRuc) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, CargadorProperties.obtenerMessages("PV_E_003"), "Error", JOptionPane.ERROR_MESSAGE);
        }
        return prv;
    }
    ...
    public ArrayList<Proveedor> consultarTodos() {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, CargadorProperties.obtenerMessages("PV_E_006"), "Error", JOptionPane.ERROR_MESSAGE);
        }
        return lista;
    }
    ...
    private Proveedor proveedorCompleto(ResultSet rs) throws SQLException {
        ...
        prv.setNombre(rs.getString(1));
        prv.setCedRuc(rs.getString(2));
        prv.setTelefono(rs.getString(3));
        prv.setCelular(rs.getString(4));
        prv.setEmail(rs.getString(5));
        prv.setIdCiudad(rs.getString(6));
        prv.setDireccion(rs.getString(7));
        prv.setEstado(rs.getString(8));
        prv.setCiudad(rs.getString(9));
        prv.setIdProveedor(rs.getString(10));
        return prv;
    }
    ...
    private Proveedor proveedorSimple(ResultSet rs) throws SQLException {
        ...
        prv.setEmail(rs.getString(5));
        prv.setIdCiudad(rs.getString(6));
        prv.setCiudad(rs.getString(7));
        prv.setDireccion(rs.getString(8));
        return prv;
    }
    ...
    public ArrayList<ItemCombo> obtenerCiudades() {
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                ItemCombo item = new ItemCombo(rs.getString("id_ciudad"), rs.getString("ciu_descripcion"));
                ciudades.add(item);
            }
            rs.close();
            ps.close();
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al cargar las ciudades", "Error", JOptionPane.ERROR_MESSAGE);
        }
        return ciudades;
    }
