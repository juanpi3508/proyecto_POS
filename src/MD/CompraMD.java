...
public class CompraMD {
    ...
    public ArrayList<Compra> consultarHistorialPorProveedor(Proveedor prov) {
        String sql = CargadorProperties.obtenerConfigCompra("comp.consultar.porProveedor.todas");
        ArrayList<Compra> lista = new ArrayList<>();
